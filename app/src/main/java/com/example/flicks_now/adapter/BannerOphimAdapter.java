...
public class BannerOphimAdapter extends PagerAdapter {

    private Activity context;
    private List<PhimAPiOphim> movies;

    public BannerOphimAdapter(Activity context, List<PhimAPiOphim> movies) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        PhimAPiOphim movie = movies.get(position);
        ...
        Glide.with(context)
                .load(movie.getPoster_url())  // Assuming you are using thumb_url for the banner
